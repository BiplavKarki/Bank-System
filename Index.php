...
<?php
  ...
  <div class="row activity text-center">
    ...
    <div class="col-md act">
      ...
      <br>
      <a href="transfermoney.php"><button style="background-color : #Black;" class="btn btn-primary">Make a Transaction</button></a>
    </div>
    <div class="col-md act">
...
<footer class="text-center mt-5 py-2">
            <p>&copy 2021. Made by <b>Biplav Karki</b> Biplav Karki Foundation</p>
    </footer>
